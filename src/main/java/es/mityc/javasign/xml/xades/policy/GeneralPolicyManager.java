...
public class GeneralPolicyManager implements IValidacionPolicy {
	...
	private byte[] transform(byte[] in, Transforms transforms, Document doc) {
		org.apache.xml.security.transforms.Transforms t = new org.apache.xml.security.transforms.Transforms(doc);
		...
		if (list != null) {
			...
			while (it.hasNext()) {
				...
				try {
					if (org.apache.xml.security.transforms.Transforms.TRANSFORM_C14N_EXCL_OMIT_COMMENTS.equals(tr.getAlgorithm())) {
						t.addTransform(org.apache.xml.security.transforms.Transforms.TRANSFORM_C14N_EXCL_OMIT_COMMENTS);
					}
					else if (org.apache.xml.security.transforms.Transforms.TRANSFORM_C14N_EXCL_WITH_COMMENTS.equals(tr.getAlgorithm())) {
						t.addTransform(org.apache.xml.security.transforms.Transforms.TRANSFORM_C14N_EXCL_WITH_COMMENTS);
					}
					else if (org.apache.xml.security.transforms.Transforms.TRANSFORM_C14N_OMIT_COMMENTS.equals(tr.getAlgorithm())) {
						t.addTransform(org.apache.xml.security.transforms.Transforms.TRANSFORM_C14N_OMIT_COMMENTS);
					}
					else if (org.apache.xml.security.transforms.Transforms.TRANSFORM_C14N_WITH_COMMENTS.equals(tr.getAlgorithm())) {
						t.addTransform(org.apache.xml.security.transforms.Transforms.TRANSFORM_C14N_WITH_COMMENTS);
					}
					else if (org.apache.xml.security.transforms.Transforms.TRANSFORM_XPATH.equals(tr.getAlgorithm())) {
						t.addTransform(org.apache.xml.security.transforms.Transforms.TRANSFORM_XPATH, tr.getExtraNodes());
					}
