...
/**
 * <p>
 * Clase de ejemplo para la firma XAdES-X tipo 1 enveloped de un documento
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class XAdESXSignature extends GenericXMLSignature {
     ...
     * </p>
     */
    private final static String SIGN_FILE_NAME = "XAdES-X-Sign.xml";
    ...
    public static void main(String[] args) {
        XAdESXSignature signature = new XAdESXSignature();
        signature.execute();
    }
